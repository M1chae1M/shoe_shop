...
(() => {
var exports = {};
exports.id = "pages/api/order/all";
exports.ids = ["pages/api/order/all"];
exports.modules = {
...
/***/ "(api)/./pages/api/order/all.js":
/*!********************************!*\
  !*** ./pages/api/order/all.js ***!
  \********************************/
/***/ ((module, exports, __webpack_require__) => {

eval("\nObject.defineProperty(exports, \"__esModule\", ({\n    value: true\n}));\nconst _interopRequireDefault = (__webpack_require__(/*! @swc/helpers/lib/_interop_require_default.js */ \"(api)/./node_modules/@swc/helpers/lib/_interop_require_default.js\")[\"default\"]);\nconst _connectionWithDB = __webpack_require__(/*! ../connectionWithDB */ \"(api)/./pages/api/connectionWithDB.js\");\nconst _authPromise = /*#__PURE__*/ _interopRequireDefault(__webpack_require__(/*! ../authPromise */ \"(api)/./pages/api/authPromise.js\"));\nmodule.exports = (req, res)=>{\n    (0, _authPromise.default)(req, res).then(({ data , login  })=>{\n        if (data.length > 0) {\n            const query = `SELECT * FROM orders WHERE user=\"${login}\"`;\n            _connectionWithDB.connection.query(query, (err, data)=>{\n                if (data.length > 0) res.status(200).json({\n                    data,\n                    message: \"\"\n                });\n                else res.status(200).json({\n                    data: [],\n                    message: \"no orders\"\n                });\n            });\n        }\n    });\n};\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/order/all.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/order/all.js"));
